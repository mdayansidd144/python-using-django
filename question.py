...
# remainder = (a%b)
# power = a**b
# print(floordivison,remainder,power)
# x = 15
# y = 40
# totalcost = 3*x + 2*y
# print(totalcost)
# c = int(input("enter the first num"))
# d = int(input("enter the sec num"))
# e = int(input("enter the third num"))
# f = int(input("enter the fourth num"))
# g = int(input("enter the fifth num"))
# avg = ((c+d+e+f+g)/5)
# print(avg)
